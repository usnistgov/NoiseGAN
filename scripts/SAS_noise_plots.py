...
SAS_parent_path = "../model_results/SAS/"
...
SAS_wave_gs_paths = [] # feature_min_max scaling
...
axs[2].set_xlabel(r"True $\alpha$", fontsize=14)
plt.tight_layout()
plt.subplots_adjust(hspace=0.05, wspace=0.1)
plt.savefig(os.path.join(plot_path, 'SAS_combined_plot.png'), dpi=600)
plt.show()
...
fig5.savefig(os.path.join(plot_path,'sas_pdfs.png'))
...
fig6.savefig(os.path.join(plot_path, 'sas_examples.png'))
...
output_path = os.path.join(plot_path, "SAS_waveform_comp_alpha100.png")
